...
public class ThrownIronSpearRenderer extends EntityRenderer<ThrownIronSpear, ThrownIronSpearRenderer.SpearRenderState> {
    ...
    @Override
    public void extractRenderState(ThrownIronSpear entity, SpearRenderState state, float partialTick) {
    ...
    public static Identifier textureLocation() {
        return Identifier.fromNamespaceAndPath(epca.MODID, "textures/entity/iron_spear.png");
    }
}