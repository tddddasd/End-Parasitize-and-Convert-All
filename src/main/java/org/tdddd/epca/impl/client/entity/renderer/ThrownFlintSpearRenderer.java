...
public class ThrownFlintSpearRenderer extends EntityRenderer<ThrownFlintSpear> {
    ...
    @Override
    public void render(ThrownFlintSpear entity, float entityYaw, float partialTick,
    ...
    @Override
    public ResourceLocation getTextureLocation(ThrownFlintSpear entity) {
        return new ResourceLocation(epca.MODID, "textures/entity/flint_spear.png");
    }
}