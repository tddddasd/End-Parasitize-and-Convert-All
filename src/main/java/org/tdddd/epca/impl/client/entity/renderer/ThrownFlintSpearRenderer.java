...
import org.tdddd.epca.impl.overworld.registry.entities.entity.misc.ThrownFlintSpear;
...
public class ThrownFlintSpearRenderer extends EntityRenderer<ThrownFlintSpear, ThrownFlintSpearRenderer.SpearRenderState> {
    ...
    public ThrownFlintSpearRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void extractRenderState(ThrownFlintSpear entity, SpearRenderState state, float partialTick) {
    ...
    public static Identifier textureLocation() {
        return Identifier.fromNamespaceAndPath(epca.MODID, "textures/entity/flint_spear.png");
    }
}