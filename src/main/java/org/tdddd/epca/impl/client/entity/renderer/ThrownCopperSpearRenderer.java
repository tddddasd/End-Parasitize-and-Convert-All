...
public class ThrownCopperSpearRenderer extends EntityRenderer<ThrownCopperSpear, ThrownCopperSpearRenderer.SpearRenderState> {
    ...
    public ThrownCopperSpearRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void extractRenderState(ThrownCopperSpear entity, SpearRenderState state, float partialTick) {
    ...
    public static Identifier textureLocation() {
        return Identifier.fromNamespaceAndPath(epca.MODID, "textures/entity/copper_spear.png");
    }
}