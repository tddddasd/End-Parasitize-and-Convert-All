...
public class ThrownCopperSpearRenderer extends EntityRenderer<ThrownCopperSpear> {
    ...
    @Override
    public void render(ThrownCopperSpear entity, float entityYaw, float partialTick,
    ...
    @Override
    public ResourceLocation getTextureLocation(ThrownCopperSpear entity) {
        return new ResourceLocation(epca.MODID, "textures/entity/copper_spear.png");
    }
}