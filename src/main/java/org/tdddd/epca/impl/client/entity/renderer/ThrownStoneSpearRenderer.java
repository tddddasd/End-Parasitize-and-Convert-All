...
public class ThrownStoneSpearRenderer extends EntityRenderer<ThrownStoneSpear, ThrownStoneSpearRenderer.SpearRenderState> {
    ...
    @Override
    public void extractRenderState(ThrownStoneSpear entity, SpearRenderState state, float partialTick) {
    ...
    public static Identifier textureLocation() {
        return Identifier.fromNamespaceAndPath(epca.MODID, "textures/entity/stone_spear.png");
    }
}