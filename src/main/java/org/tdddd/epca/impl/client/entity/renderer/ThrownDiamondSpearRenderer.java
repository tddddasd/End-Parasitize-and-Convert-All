...
public class ThrownDiamondSpearRenderer extends EntityRenderer<ThrownDiamondSpear> {
    ...
    @Override
    public void render(ThrownDiamondSpear entity, float entityYaw, float partialTick,
    ...
    @Override
    public ResourceLocation getTextureLocation(ThrownDiamondSpear entity) {
        return new ResourceLocation(epca.MODID, "textures/entity/diamond_spear.png");
    }
}