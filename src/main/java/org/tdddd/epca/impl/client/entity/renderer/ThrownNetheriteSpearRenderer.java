...
import org.tdddd.epca.impl.overworld.registry.entities.entity.misc.ThrownNetheriteSpear;
...
public class ThrownNetheriteSpearRenderer extends EntityRenderer<ThrownNetheriteSpear, ThrownNetheriteSpearRenderer.SpearRenderState> {
    ...
    public ThrownNetheriteSpearRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void extractRenderState(ThrownNetheriteSpear entity, SpearRenderState state, float partialTick) {
    ...
    public static Identifier textureLocation() {
        return Identifier.fromNamespaceAndPath(epca.MODID, "textures/entity/netherite_spear.png");
    }
}