...
public class ThrownNetheriteSpearRenderer extends EntityRenderer<ThrownNetheriteSpear> {
    ...
    @Override
    public void render(ThrownNetheriteSpear entity, float entityYaw, float partialTick,
    ...
    @Override
    public ResourceLocation getTextureLocation(ThrownNetheriteSpear entity) {
        return new ResourceLocation(epca.MODID, "textures/entity/netherite_spear.png");
    }
}