...
public final class GasCloudRenderType {
     ...
     * values are cross-checked by {@code build/javac-check/check-glsl-26.py}.</p>
     */
     ...
     * {@code build/javac-check/check-glsl-26.py}); the shader is the only reader, it is mirrored so a
