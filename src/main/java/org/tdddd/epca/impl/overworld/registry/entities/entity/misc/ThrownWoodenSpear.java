...
public class ThrownWoodenSpear extends AbstractArrow {
    private static final float CUSTOM_GRAVITY = 0.0475f; 
    private ItemStack spearItem;
    private boolean dealtDamage = false;
    private int returnTimer = 0;
    private final boolean wasCreativeThrower; 

    public ThrownWoodenSpear(EntityType<? extends ThrownWoodenSpear> type, Level level) {
        super(type, level);
        this.spearItem = new ItemStack(ModItems.WOODEN_SPEAR.get());
        this.setNoGravity(true); 
        this.wasCreativeThrower = false;   
    }

    public ThrownWoodenSpear(Level level, LivingEntity shooter, ItemStack stack, boolean isCreative) {
        super(ModEntities.THROWN_WOODEN_SPEAR.get(), shooter, level, new ItemStack(ModItems.WOODEN_SPEAR.get()), null);
