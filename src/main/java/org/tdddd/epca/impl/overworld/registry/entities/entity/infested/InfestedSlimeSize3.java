...
public class InfestedSlimeSize3 extends PathfinderMob implements GeoEntity, IParasite, IInfested, Enemy {
                ...
                if (!this.level().isClientSide() && this.level() instanceof ServerLevel serverLevel) {
                    ...
                    for (int i = 0; i < spawnCount; i++) {
                        ...
                        if (mediumSlime != null) {
                            ...
                            if (this.isOnFire()) {
                                mediumSlime.igniteForSeconds(this.getRemainingFireTicks() / 20);
                            }
    ...
    private void checkContactDamage() {
        ...
        for (LivingEntity target : this.level().getEntitiesOfClass(LivingEntity.class, collisionBox)) {
            ...
            if (this.getBoundingBox().intersects(target.getBoundingBox())) {
                ...
                boolean hurt = target.hurtOrSimulate(magicDamage, 6.0F);
    ...
    private PlayState playState(AnimationTest<InfestedSlimeSize3> event) {
