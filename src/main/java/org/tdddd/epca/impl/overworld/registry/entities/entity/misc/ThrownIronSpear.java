...
public class ThrownIronSpear extends AbstractArrow {
    private static final float CUSTOM_GRAVITY = 0.0375f; 
    private ItemStack spearItem;
    private boolean dealtDamage = false;
    private int returnTimer = 0;
    private final boolean wasCreativeThrower; 

    public ThrownIronSpear(EntityType<? extends ThrownIronSpear> type, Level level) {
        super(type, level);
        this.spearItem = new ItemStack(ModItems.IRON_SPEAR.get());
        this.setNoGravity(true); 
        this.wasCreativeThrower = false;   
    }

    public ThrownIronSpear(Level level, LivingEntity shooter, ItemStack stack, boolean isCreative) {
        super(ModEntities.THROWN_IRON_SPEAR.get(), shooter, level, new ItemStack(ModItems.IRON_SPEAR.get()), null);
