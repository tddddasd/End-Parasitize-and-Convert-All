...
public class InfestedInfestedCobblestone extends Block implements InfestedBlockInterface {
    
    public static final BooleanProperty NATURAL_SPAWN = BooleanProperty.create("natural_spawn");

    public InfestedInfestedCobblestone(Properties properties) {
    ...
    protected com.mojang.serialization.MapCodec<? extends Block> codec() {
        return simpleCodec(InfestedInfestedCobblestone::new);
    }
