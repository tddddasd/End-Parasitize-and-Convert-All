...
public class LivingFleshSize2 extends PathfinderMob implements GeoEntity, IParasite, IPoverty, Enemy {
    private final AnimatableInstanceCache factory = GeckoLibUtil.createInstanceCache(this);
    private static final RawAnimation ANIM_IDLE = RawAnimation.begin().thenLoop("size2_idle");
    private static final RawAnimation ANIM_WALK = RawAnimation.begin().thenLoop("size2_walk");
    private static final RawAnimation ANIM_IDLE_WATER = RawAnimation.begin().thenLoop("size2_idle_water");
    private static final RawAnimation ANIM_SWIM = RawAnimation.begin().thenLoop("size2_swim");
    private static final RawAnimation ANIM_GROW_LAND = RawAnimation.begin().thenPlay("size1_grow_to_size2");
    private static final RawAnimation ANIM_GROW_WATER = RawAnimation.begin().thenPlay("size1_grow_to_size2_water");
    ...
    public LivingFleshSize2(EntityType<? extends PathfinderMob> type, Level level) {
        super(type, level);
        this.xpReward = 0;
    ...
    static class FindGroupGoal extends Goal {
        private final LivingFleshSize2 entity;
        private final double speedModifier;
        private final float searchRange;
        private LivingEntity target;
        private int cooldown;

        public FindGroupGoal(LivingFleshSize2 entity, double speedModifier, float searchRange) {
            this.entity = entity;
        ...
        private LivingFleshSize2 findNearbyLivingFlesh() {
            List<LivingFleshSize2> nearby = this.entity.level().getEntitiesOfClass(
                    LivingFleshSize2.class,
                    this.entity.getBoundingBox().inflate(this.searchRange)
            );

            for (LivingFleshSize2 flesh : nearby) {
    ...
    static class AvoidNonParasiteGoal extends Goal {
        ...
        public AvoidNonParasiteGoal(LivingFleshSize2 entity, double walkSpeedModifier, float maxDist) {
            this.entity = entity;
    ...
    public static boolean checkLivingFleshSize2SpawnRules(
            EntityType<LivingFleshSize2> entityType,
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<LivingFleshSize2>(this, "controller", EpcaGeoAnimations.GEO_TRANSITION_TICKS, this::predicate));
    }

    
    private PlayState predicate(AnimationState<LivingFleshSize2> event) {
        AnimationController<LivingFleshSize2> controller = event.getController();
        LivingFleshSize2 entity = event.getAnimatable();
    ...
    static class WaterMoveControl extends MoveControl {
        ...
        public WaterMoveControl(LivingFleshSize2 entity) {
            super(entity);
            this.entity = entity;
        }
