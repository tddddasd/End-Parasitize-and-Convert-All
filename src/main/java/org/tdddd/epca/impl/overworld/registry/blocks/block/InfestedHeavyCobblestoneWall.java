...
public class InfestedHeavyCobblestoneWall extends WallBlock implements InfestedBlockInterface {
    public static final BooleanProperty NATURAL_SPAWN = BooleanProperty.create("natural_spawn");

    public InfestedHeavyCobblestoneWall(Properties properties) {
        super(properties);
