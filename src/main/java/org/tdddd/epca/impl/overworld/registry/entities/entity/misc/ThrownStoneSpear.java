...
public class ThrownStoneSpear extends AbstractArrow {
    private static final float CUSTOM_GRAVITY = 0.045f; 
    private ItemStack spearItem;
    private boolean dealtDamage = false;
    private int returnTimer = 0;
    private final boolean wasCreativeThrower; 

    public ThrownStoneSpear(EntityType<? extends ThrownStoneSpear> type, Level level) {
        super(type, level);
        this.spearItem = new ItemStack(ModItems.STONE_SPEAR.get());
        this.setNoGravity(true); 
        this.wasCreativeThrower = false;   
    }

    public ThrownStoneSpear(Level level, LivingEntity shooter, ItemStack stack, boolean isCreative) {
        super(ModEntities.THROWN_STONE_SPEAR.get(), shooter, level, new ItemStack(ModItems.STONE_SPEAR.get()), null);
    ...
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItems.STONE_SPEAR.get());
    }
