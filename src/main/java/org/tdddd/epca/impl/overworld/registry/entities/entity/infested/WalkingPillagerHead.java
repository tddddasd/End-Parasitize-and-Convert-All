...
public class WalkingPillagerHead extends PathfinderMob implements GeoEntity, IParasite, IInfested, Enemy {
    ...
    public WalkingPillagerHead(EntityType<? extends PathfinderMob> type, Level level) {
        super(type, level);
        this.xpReward = 8;
    ...
    private PlayState animationPredicate(AnimationState<WalkingPillagerHead> event) {
    ...
    public static boolean checkWalkingPillagerHeadSpawnRules(
            EntityType<WalkingPillagerHead> entityType,
