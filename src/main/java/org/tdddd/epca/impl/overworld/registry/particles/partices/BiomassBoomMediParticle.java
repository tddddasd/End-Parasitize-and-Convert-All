...
public class BiomassBoomMediParticle extends TextureSheetParticle {
    ...
    public static class BiomassBoomMediParticleProvider implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet sprites;

        public BiomassBoomMediParticleProvider(SpriteSet sprites) {
            this.sprites = sprites;
        }
