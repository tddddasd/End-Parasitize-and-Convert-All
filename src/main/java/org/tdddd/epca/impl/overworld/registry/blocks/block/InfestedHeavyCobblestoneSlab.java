...
public class InfestedHeavyCobblestoneSlab extends SlabBlock implements InfestedBlockInterface {

    public static final BooleanProperty NATURAL_SPAWN = BooleanProperty.create("natural_spawn");

    public InfestedHeavyCobblestoneSlab(Properties properties) {
        super(properties);
