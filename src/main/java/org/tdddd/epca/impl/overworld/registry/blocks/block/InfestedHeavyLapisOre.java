...
public class InfestedHeavyLapisOre extends Block implements InfestedBlockInterface {
    
    public static final BooleanProperty NATURAL_SPAWN = BooleanProperty.create("natural_spawn");

    public InfestedHeavyLapisOre(Properties properties) {
        super(properties);
    ...
    public SoundType getSoundType(BlockState state, LevelReader level, BlockPos pos, @Nullable Entity entity) {
        return Blocks.DEEPSLATE_LAPIS_ORE.getSoundType(Blocks.DEEPSLATE_LAPIS_ORE.defaultBlockState(), level, pos, entity);
    }
