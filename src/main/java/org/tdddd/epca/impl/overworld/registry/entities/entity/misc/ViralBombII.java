...
public class ViralBombII extends Entity implements GeoEntity, IParasite {
    private final AnimatableInstanceCache factory = GeckoLibUtil.createInstanceCache(this);
    private static final EntityDataAccessor<Boolean> DUMMY = SynchedEntityData.defineId(ViralBombII.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> TICK_COUNT = SynchedEntityData.defineId(ViralBombII.class, EntityDataSerializers.INT);
    ...
    public ViralBombII(EntityType<? extends Entity> type, Level level) {
        super(type, level);
    }
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<ViralBombII>(this, "controller", 0, this::predicate));
    }

    private PlayState predicate(AnimationState<ViralBombII> event) {
        AnimationController<ViralBombII> controller = event.getController();
        int currentTick = this.entityData.get(TICK_COUNT);
