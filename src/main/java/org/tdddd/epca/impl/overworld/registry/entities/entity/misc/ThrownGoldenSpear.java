...
public class ThrownGoldenSpear extends AbstractArrow {
    private static final float CUSTOM_GRAVITY = 0.035f; 
    private ItemStack spearItem;
    private boolean dealtDamage = false;
    private int returnTimer = 0;
    private final boolean wasCreativeThrower; 

    public ThrownGoldenSpear(EntityType<? extends ThrownGoldenSpear> type, Level level) {
        super(type, level);
        this.spearItem = new ItemStack(ModItems.GOLDEN_SPEAR.get());
        this.setNoGravity(true); 
        this.wasCreativeThrower = false;   
    }

    public ThrownGoldenSpear(Level level, LivingEntity shooter, ItemStack stack, boolean isCreative) {
        super(ModEntities.THROWN_GOLDEN_SPEAR.get(), shooter, level, new ItemStack(ModItems.GOLDEN_SPEAR.get()), null);
    ...
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItems.GOLDEN_SPEAR.get());
    }
