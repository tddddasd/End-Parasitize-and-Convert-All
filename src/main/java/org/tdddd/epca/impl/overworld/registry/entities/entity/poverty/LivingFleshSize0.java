...
public class LivingFleshSize0 extends PathfinderMob implements GeoEntity, IParasite, IPoverty, Enemy {
    private final AnimatableInstanceCache factory = GeckoLibUtil.createInstanceCache(this);
    private static final RawAnimation ANIM_IDLE = RawAnimation.begin().thenLoop("size0_idle");
    private static final RawAnimation ANIM_WALK = RawAnimation.begin().thenLoop("size0_walk");
    private static final RawAnimation ANIM_IDLE_WATER = RawAnimation.begin().thenLoop("size0_idle_water");
    private static final RawAnimation ANIM_SWIM = RawAnimation.begin().thenLoop("size0_swim");
    ...
    static class FindGroupGoal extends Goal {
        ...
        public FindGroupGoal(LivingFleshSize0 entity, double speedModifier, float searchRange) {
            this.entity = entity;
        ...
        private LivingFleshSize0 findNearbyLivingFlesh() {
            List<LivingFleshSize0> nearby = this.entity.level().getEntitiesOfClass(
                    LivingFleshSize0.class,
                    this.entity.getBoundingBox().inflate(this.searchRange)
            );

            for (LivingFleshSize0 flesh : nearby) {
    ...
    static class AvoidNonParasiteGoal extends Goal {
        ...
        public AvoidNonParasiteGoal(LivingFleshSize0 entity, double walkSpeedModifier, float maxDist) {
            this.entity = entity;
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<LivingFleshSize0>(this, "controller", EpcaGeoAnimations.GEO_TRANSITION_TICKS, this::predicate));
    }
    ...
    static class WaterMoveControl extends MoveControl {
        ...
        public WaterMoveControl(LivingFleshSize0 entity) {
            super(entity);
            this.entity = entity;
        }
