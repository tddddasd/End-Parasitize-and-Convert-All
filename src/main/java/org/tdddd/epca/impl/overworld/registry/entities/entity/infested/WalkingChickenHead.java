...
public class WalkingChickenHead extends PathfinderMob implements GeoEntity, IParasite, IInfested, Enemy {
    ...
    public WalkingChickenHead(EntityType<? extends PathfinderMob> type, Level level) {
        super(type, level);
        this.xpReward = 8;
    ...
    private PlayState animationPredicate(AnimationState<WalkingChickenHead> event) {
    ...
    public static boolean checkWalkingChickenHeadSpawnRules(
            EntityType<WalkingChickenHead> entityType,
