...
public class InfestedMetallike extends Block implements InfestedBlockInterface {
    
    public static final BooleanProperty NATURAL_SPAWN = BooleanProperty.create("natural_spawn");

    public InfestedMetallike(Properties properties) {
        super(properties);
    ...
    public SoundType getSoundType(BlockState state, LevelReader level, BlockPos pos, @Nullable Entity entity) {
        return Blocks.IRON_BLOCK.getSoundType(Blocks.IRON_BLOCK.defaultBlockState(), level, pos, entity);
    }
