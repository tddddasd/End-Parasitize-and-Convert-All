...
public class InfestedStoneBricksWall extends WallBlock implements InfestedBlockInterface {
    public static final BooleanProperty NATURAL_SPAWN = BooleanProperty.create("natural_spawn");

    public InfestedStoneBricksWall(Properties properties) {
        super(properties);
    ...
    public SoundType getSoundType(BlockState state, LevelReader level, BlockPos pos, @Nullable Entity entity) {
        return Blocks.STONE_BRICK_WALL.getSoundType(Blocks.STONE_BRICK_WALL.defaultBlockState(), level, pos, entity);
    }
