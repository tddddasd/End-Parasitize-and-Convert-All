...
public class LivingFleshSize1 extends PathfinderMob implements GeoEntity, IParasite, IPoverty, Enemy {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<LivingFleshSize1>("controller", EpcaAnimations.GEO_TRANSITION_TICKS, this::predicate));
    }
    private PlayState predicate(AnimationTest<LivingFleshSize1> event) {
        AnimationController<LivingFleshSize1> controller = event.controller();
        LivingFleshSize1 entity = event.animatable();
