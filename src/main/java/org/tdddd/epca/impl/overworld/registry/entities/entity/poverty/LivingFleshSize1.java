...
public class LivingFleshSize1 extends PathfinderMob implements GeoEntity, IParasite, IPoverty, Enemy {
    private final AnimatableInstanceCache factory = GeckoLibUtil.createInstanceCache(this);
    private static final RawAnimation ANIM_IDLE = RawAnimation.begin().thenLoop("size1_idle");
    private static final RawAnimation ANIM_WALK = RawAnimation.begin().thenLoop("size1_walk");
    private static final RawAnimation ANIM_IDLE_WATER = RawAnimation.begin().thenLoop("size1_idle_water");
    private static final RawAnimation ANIM_SWIM = RawAnimation.begin().thenLoop("size1_swim");
    private static final RawAnimation ANIM_GROW_LAND = RawAnimation.begin().thenPlay("size0_grow_to_size1");
    private static final RawAnimation ANIM_GROW_WATER = RawAnimation.begin().thenPlay("size0_grow_to_size1_water");
    ...
    public LivingFleshSize1(EntityType<? extends PathfinderMob> type, Level level) {
        super(type, level);
        this.xpReward = 0;
    ...
    static class FindGroupGoal extends Goal {
        private final LivingFleshSize1 entity;
        private final double speedModifier;
        private final float searchRange;
        private LivingEntity target;
        private int cooldown;

        public FindGroupGoal(LivingFleshSize1 entity, double speedModifier, float searchRange) {
            this.entity = entity;
        ...
        private LivingFleshSize1 findNearbyLivingFlesh() {
            List<LivingFleshSize1> nearby = this.entity.level().getEntitiesOfClass(
                    LivingFleshSize1.class,
                    this.entity.getBoundingBox().inflate(this.searchRange)
            );

            for (LivingFleshSize1 flesh : nearby) {
    ...
    static class AvoidNonParasiteGoal extends Goal {
        ...
        public AvoidNonParasiteGoal(LivingFleshSize1 entity, double walkSpeedModifier, float maxDist) {
            this.entity = entity;
    ...
    public static boolean checkLivingFleshSize1SpawnRules(
            EntityType<LivingFleshSize1> entityType,
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<LivingFleshSize1>(this, "controller", EpcaGeoAnimations.GEO_TRANSITION_TICKS, this::predicate));
    }

    
    private PlayState predicate(AnimationState<LivingFleshSize1> event) {
        AnimationController<LivingFleshSize1> controller = event.getController();
        LivingFleshSize1 entity = event.getAnimatable();
    ...
    static class WaterMoveControl extends MoveControl {
        ...
        public WaterMoveControl(LivingFleshSize1 entity) {
            super(entity);
            this.entity = entity;
        }
