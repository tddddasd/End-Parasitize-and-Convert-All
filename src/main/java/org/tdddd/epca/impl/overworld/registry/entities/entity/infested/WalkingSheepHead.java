...
public class WalkingSheepHead extends PathfinderMob implements GeoEntity, IParasite, IInfested, Enemy {
    ...
    public WalkingSheepHead(EntityType<? extends PathfinderMob> type, Level level) {
        super(type, level);
        this.xpReward = 8;
    ...
    public static AttributeSupplier setAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, 3.9D) 
    ...
    private PlayState animationPredicate(AnimationState<WalkingSheepHead> event) {
    ...
    public static boolean checkWalkingSheepHeadSpawnRules(
            EntityType<WalkingSheepHead> entityType,
