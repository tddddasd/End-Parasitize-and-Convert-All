...
public class ThrownNetheriteSpear extends AbstractArrow {
    private static final float CUSTOM_GRAVITY = 0.03f; 
    ...
    public ThrownNetheriteSpear(EntityType<? extends ThrownNetheriteSpear> type, Level level) {
        super(type, level);
        this.spearItem = new ItemStack(ModItems.NETHERITE_SPEAR.get());
        this.setNoGravity(true); 
        this.wasCreativeThrower = false;   
    }

    public ThrownNetheriteSpear(Level level, LivingEntity shooter, ItemStack stack, boolean isCreative) {
        super(ModEntities.THROWN_NETHERITE_SPEAR.get(), shooter, level, new ItemStack(ModItems.NETHERITE_SPEAR.get()), null);
    ...
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItems.NETHERITE_SPEAR.get());
    }
