...
public class InfestedPolishedHeavyStoneWall extends WallBlock implements InfestedBlockInterface {
    public static final BooleanProperty NATURAL_SPAWN = BooleanProperty.create("natural_spawn");

    public InfestedPolishedHeavyStoneWall(Properties properties) {
        super(properties);
    ...
    public SoundType getSoundType(BlockState state, LevelReader level, BlockPos pos, @Nullable Entity entity) {
        return Blocks.COBBLED_DEEPSLATE_WALL.getSoundType(Blocks.COBBLED_DEEPSLATE_WALL.defaultBlockState(), level, pos, entity);
    }
