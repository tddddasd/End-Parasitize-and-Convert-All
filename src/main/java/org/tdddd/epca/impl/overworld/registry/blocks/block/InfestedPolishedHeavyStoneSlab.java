...
public class InfestedPolishedHeavyStoneSlab extends SlabBlock implements InfestedBlockInterface {

    public static final BooleanProperty NATURAL_SPAWN = BooleanProperty.create("natural_spawn");

    public InfestedPolishedHeavyStoneSlab(Properties properties) {
        super(properties);
