...
public class WalkingZombieVillagerHead extends PathfinderMob implements GeoEntity, IParasite, IInfested, Enemy {
    ...
    public WalkingZombieVillagerHead(EntityType<? extends PathfinderMob> type, Level level) {
        super(type, level);
        this.xpReward = 8;
    ...
    private PlayState animationPredicate(AnimationState<WalkingZombieVillagerHead> event) {
    ...
    public static boolean checkWalkingZombieVillagerHeadSpawnRules(
            EntityType<WalkingZombieVillagerHead> entityType,
