...
public class InfestedRemainsSmall extends Block {
    
    private static final VoxelShape INTERACTION_SHAPE = Block.box(0.0D, 0.0D, 0.0D, 16.0D, 3.0D, 16.0D); 
     ...
     */
    public InfestedRemainsSmall(Properties properties) {
        super(properties);
    }

    /** Kept for {@code simpleCodec} / hand construction with the original defaults. */
    public InfestedRemainsSmall() {
        this(Properties.of()
                .noOcclusion() 
                .strength(0.0f) 
    ...
    protected com.mojang.serialization.MapCodec<? extends Block> codec() {
        return simpleCodec(InfestedRemainsSmall::new);
    }
