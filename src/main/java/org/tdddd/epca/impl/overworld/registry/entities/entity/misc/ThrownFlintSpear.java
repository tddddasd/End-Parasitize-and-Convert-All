...
public class ThrownFlintSpear extends AbstractArrow {
    private static final float CUSTOM_GRAVITY = 0.0425f; 
    private ItemStack spearItem;
    private boolean dealtDamage = false;
    private int returnTimer = 0;
    private final boolean wasCreativeThrower; 

    public ThrownFlintSpear(EntityType<? extends ThrownFlintSpear> type, Level level) {
        super(type, level);
        this.spearItem = new ItemStack(ModItems.FLINT_SPEAR.get());
