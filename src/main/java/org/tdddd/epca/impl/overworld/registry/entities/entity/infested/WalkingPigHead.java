...
public class WalkingPigHead extends PathfinderMob implements GeoEntity, IParasite, IInfested, Enemy {
    ...
    public WalkingPigHead(EntityType<? extends PathfinderMob> type, Level level) {
        super(type, level);
        this.xpReward = 8;
    ...
    public static AttributeSupplier setAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, 2.7D) 
                .add(Attributes.MOVEMENT_SPEED, 0.28D) 
                .add(Attributes.ATTACK_DAMAGE, 1.05D) 
    ...
    private PlayState animationPredicate(AnimationState<WalkingPigHead> event) {
    ...
    public static boolean checkWalkingPigHeadSpawnRules(
            EntityType<WalkingPigHead> entityType,
