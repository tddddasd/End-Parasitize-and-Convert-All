...
public class LivingFleshSize4 extends PathfinderMob implements GeoEntity, IParasite, IPoverty, Enemy {
    private final AnimatableInstanceCache factory = GeckoLibUtil.createInstanceCache(this);
    private static final RawAnimation ANIM_IDLE = RawAnimation.begin().thenLoop("size4_idle");
    private static final RawAnimation ANIM_WALK = RawAnimation.begin().thenLoop("size4_walk");
    private static final RawAnimation ANIM_IDLE_WATER = RawAnimation.begin().thenLoop("size4_idle_water");
    private static final RawAnimation ANIM_SWIM = RawAnimation.begin().thenLoop("size4_swim");
    private static final RawAnimation ANIM_GROW_LAND = RawAnimation.begin().thenPlay("size3_grow_to_size4");
    private static final RawAnimation ANIM_GROW_WATER = RawAnimation.begin().thenPlay("size3_grow_to_size4_water");
    ...
    public LivingFleshSize4(EntityType<? extends PathfinderMob> type, Level level) {
        super(type, level);
        this.xpReward = 0;
    ...
    static class FindGroupGoal extends Goal {
        private final LivingFleshSize4 entity;
        private final double speedModifier;
        private final float searchRange;
        private LivingEntity target;
        private int cooldown;

        public FindGroupGoal(LivingFleshSize4 entity, double speedModifier, float searchRange) {
            this.entity = entity;
        ...
        private LivingFleshSize4 findNearbyLivingFlesh() {
            List<LivingFleshSize4> nearby = this.entity.level().getEntitiesOfClass(
                    LivingFleshSize4.class,
                    this.entity.getBoundingBox().inflate(this.searchRange)
            );

            for (LivingFleshSize4 flesh : nearby) {
    ...
    static class AvoidNonParasiteGoal extends Goal {
        ...
        public AvoidNonParasiteGoal(LivingFleshSize4 entity, double walkSpeedModifier, float maxDist) {
            this.entity = entity;
    ...
    public static boolean checkLivingFleshSize4SpawnRules(
            EntityType<LivingFleshSize4> entityType,
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<LivingFleshSize4>(this, "controller", EpcaGeoAnimations.GEO_TRANSITION_TICKS, this::predicate));
    }

    
    private PlayState predicate(AnimationState<LivingFleshSize4> event) {
        AnimationController<LivingFleshSize4> controller = event.getController();
        LivingFleshSize4 entity = event.getAnimatable();
    ...
    static class WaterMoveControl extends MoveControl {
        ...
        public WaterMoveControl(LivingFleshSize4 entity) {
            super(entity);
            this.entity = entity;
        }
