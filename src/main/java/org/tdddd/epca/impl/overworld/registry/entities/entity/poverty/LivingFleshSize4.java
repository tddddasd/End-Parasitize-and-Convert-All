...
public class LivingFleshSize4 extends PathfinderMob implements GeoEntity, IParasite, IPoverty, Enemy {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<LivingFleshSize4>("controller", EpcaAnimations.GEO_TRANSITION_TICKS, this::predicate));
    }
    private PlayState predicate(AnimationTest<LivingFleshSize4> event) {
        AnimationController<LivingFleshSize4> controller = event.controller();
        LivingFleshSize4 entity = event.animatable();
