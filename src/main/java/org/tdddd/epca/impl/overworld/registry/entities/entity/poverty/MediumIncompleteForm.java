...
public class MediumIncompleteForm extends PathfinderMob implements GeoEntity, IParasite, IPoverty, Enemy {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(6, new MediumIncompleteForm.RandomSoundGoal(this));
    ...
    static class RandomSoundGoal extends Goal {
        private final MediumIncompleteForm mediumIncompleteForm;
        ...
        @Override
        public void start() {
            this.nextSoundTick = mediumIncompleteForm.getRandom().nextInt(140) + 80;
        }
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<MediumIncompleteForm>("controller", EpcaAnimations.GEO_TRANSITION_TICKS, this::predicate));
    }
