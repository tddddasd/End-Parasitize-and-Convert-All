...
public class WalkingVillagerHead extends PathfinderMob implements GeoEntity, IParasite, IInfested, Enemy {
    ...
    public WalkingVillagerHead(EntityType<? extends PathfinderMob> type, Level level) {
        super(type, level);
        this.xpReward = 8;
    ...
    private PlayState animationPredicate(AnimationState<WalkingVillagerHead> event) {
    ...
    public static boolean checkWalkingVillagerHeadSpawnRules(
            EntityType<WalkingVillagerHead> entityType,
